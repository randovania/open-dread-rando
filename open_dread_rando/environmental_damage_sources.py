...
_ALL_DAMAGE_ROOM_ACTORS = [_ARTARIA_HEAT_ROOM_ACTORS, _ARTARIA_COLD_ROOM_ACTORS, _CATARIS_HEAT_ROOM_ACTORS, _DAIRON_HEAT_ROOM_ACTORS, _DAIRON_COLD_ROOM_ACTORS, _FERENIA_COLD_ROOM_ACTORS]
